...
const ApplicationDetails = () => {
  ...
  if (!application.jobId) {
    return (
      <div className="text-center mt-10 text-red-500">
        Job has been deleted for this Application.
      </div>
    );
  }
    ...
    <div className="max-w-4xl mx-auto py-10 px-6 bg-white rounded-xl shadow-lg">
      ...
      <div className="border-b pb-6 mb-6">
        ...
        <p className="mt-2">
          ...
          <a
            href={`${import.meta.env.VITE_API_RESUME_URL}/${
              application.resume
            }`}
            target="_blank"
      ...
      <div>
        ...
        <div className="flex items-center gap-4 text-sm text-gray-600 mt-2">
          <span className="flex items-center gap-1">
            <FaMapMarkerAlt /> {jobId.location}
          </span>
          <span className="flex items-center gap-1">
            <FaBriefcase /> {jobId.type}
          </span>
          <span className="flex items-center gap-1">
            <FaMoneyBillWave /> {jobId.salary}
          </span>
        </div>
